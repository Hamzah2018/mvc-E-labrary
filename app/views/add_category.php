...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_category" method="POST" enctype="multipart/form-data">
    <h6>انشاء صنف جديد </h6>
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> اسم الصنف </label>
        <input name="category_name" type="text" id="multicol-username" class="form-control" placeholder="..." />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">صوره الصنف </label>
