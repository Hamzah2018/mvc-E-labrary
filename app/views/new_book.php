...
<div class="card mb-4">
  ...
  <div class="col-md-6">
        ...
        <input name="price" type="number" id="multicol-username" class="form-control" placeholder="0000.0" />
      </div>
  <div class="col-md-6">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Page nuber</label>
        <input name="pages_number" type="number" id="multicol-username" class="form-control" placeholder="00" />
      </div>
      <div class="col-md-6">
