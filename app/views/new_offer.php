...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
      ...
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  تخفيض  </label>
        <input name="discout" type="number" id="multicol-username" class="form-control" placeholder="000" />
      </div>
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  تاريخ البداء  </label>
        <input name="start-date" type="date" id="multicol-username" class="form-control" placeholder="000" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  تاريخ الانتهاء  </label>
        <input name="end-date" type="date" id="multicol-username" class="form-control" placeholder="000" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> عنوان العرض  </label>
        <input name="title" type="text" id="multicol-username" class="form-control" placeholder="..." />
      ...
      <div class="col-md-6 mb-4">
            <label for="selectpickerIcons" class="form-label">اسم الكتاب</label>
            <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default">
              <option data-icon="bx bxl-instagram">تعلم</option>
              <option data-icon="bx bxl-pinterest-alt">تعلم</option>
              <option data-icon="bx bxl-twitch">تعلم</option>
            </select>
          </div>
      <div class="col-md-6 mb-4">
            <label for="selectpickerIcons" class="form-label">اصنف الكتاب</label>
            <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default">
              <option data-icon="bx bxl-instagram">ديني</option>
              <option data-icon="bx bxl-pinterest-alt">لغوي </option>
              <option data-icon="bx bxl-twitch">برمجه</option>
            </select>
          </div>
      <div class="row g-3">
    </div>
