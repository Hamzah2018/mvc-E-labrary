...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="col-md-6 mb-4">
      ...
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  الاجمالي  </label>
        <input name="discout" type="number" id="multicol-username" class="form-control" placeholder="000" />
      </div>
    
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  التخفيض  </label>
        <input name="discout" type="number" id="multicol-username" class="form-control" placeholder="000" />
      </div>
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">  الاجمال المستحق  </label>
        <input name="discout" type="number" id="multicol-username" class="form-control" placeholder="000" />
      </div>
      <div class="col-md-6 mb-4">
            <label for="selectpickerIcons" class="form-label">طرف الدفع </label>
            <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default">
              <option data-icon="bx bxl-instagram">Mastercard </option>
              <option data-icon="bx bxl-pinterest-alt">visa</option>
              <option data-icon="bx bxl-twitch">paypal</option>
            </select>
          </div>
          <div class="col-md-6 mb-4">
            <label for="selectpickerIcons" class="form-label">العنوان  </label>
            <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default">
              <option data-icon="bx bxl-instagram"> </option>
              <option data-icon="bx bxl-pinterest-alt"></option>
              <option data-icon="bx bxl-twitch"></option>
            </select>
          </div>
