...
<body id="body">
   <dir style="padding-right: 15px;padding-top: 8px;"> 
       ...
       <p class="tog-menu-p" >القائمه</p>
                  ...
                  <section class="catgers" id = "cat-section">
                      <aside class="cat-descrip">
                        ...
                        <section class="books" id="book-cat">
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book1.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book2.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book3.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book4.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book6.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book1.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book2.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book3.jpg" alt=""></div>
                            <div class="book-img-container"><img onclick="callImage(this);"  class="book-img" src="assets/img/catagers/books/books/book4.jpg" alt=""></div>
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book6.jpg" alt="">
            <h2>كتاب</h2>
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book1.jpg" alt="">
            <h2>كتاب</h2>
        <small> رياضي لون سماء</small>
        <h4>ر.س 99</h4>
         <div class="icon-catgere-card">
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book2.jpg" alt="">
            <h2>كتاب</h2>
        <small> رياضي لون سماء</small>
        <h4>ر.س 99</h4>
         <div class="icon-catgere-card">
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book3.jpg" alt="">
            <h2>كتاب</h2>
        <small> رياضي لون سماء</small>
        <h4>ر.س 99</h4>
         <div class="icon-catgere-card">
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book4.jpg" alt="">
            <h2>كتاب</h2>
        <small> رياضي لون سماء</small>
        <h4>ر.س 99</h4>
         <div class="icon-catgere-card">
        ...
        <div class="catg-card">
            <img src="assets/img/catagers/books/book7.jpg" alt="">
            <h2>كتاب</h2>
        <small> رياضي لون سماء</small>
        <h4>ر.س 99</h4>
         <div class="icon-catgere-card">
