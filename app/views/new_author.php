...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">اسم الملف</label>
        <input name="title" type="text" id="multicol-username" class="form-control" placeholder="..." />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">رقم الهاتف </label>
        <input name="title" type="text" id="multicol-username" class="form-control" placeholder="7..." />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">ايمله</label>
        <input name="title" type="email" id="multicol-username" class="form-control" placeholder="@something.com" />
      </div>
      <div class="row g-3">
    </div>
  ...
  <div class="col-md-6">
        ...
        <!-- <input name="description" type="number" id="multicol-username" class="form-control" placeholder="...." /> -->
        <textarea name="description" class="form-control" aria-label="With textarea" placeholder="...."></textarea>
      </div>
